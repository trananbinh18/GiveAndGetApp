...
public class ResultListUserLikeAdapter extends BaseAdapter {
    ...
    public ResultListUserLikeAdapter(Activity activity, Context context, ArrayList<ResultListUser> listResultUser){
